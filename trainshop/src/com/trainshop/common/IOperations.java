...
public interface IOperations<T extends Serializable> {
	 ...
	 * @throws Exception
	 */
	public List<T> searchByHql(String hql, Map<String, Object> parameters, Integer start, Integer limit);
	 ...
	 * @return
	 */
	public List<T> searchBySql(String sql, Object para[], Integer start, Integer limit);
	 ...
	 * @return
	 */
	public List<T> searchByDetachedCriteria(DetachedCriteria dc, Integer start, Integer limit);
